...
import { View, StyleSheet, Pressable, ScrollView, Dimensions, LayoutChangeEvent, Platform, Alert } from "react-native";
  ...
  if (!story) {
    return (
      <ThemedView style={[styles.container, { paddingTop: insets.top }]}>
        <ThemedText>{t("stories:storyNotFound")}</ThemedText>
      </ThemedView>
    );
  }
    ...
    <ThemedView style={styles.container}>
      <View style={[styles.header, { paddingTop: insets.top + Spacing.md }]}>
        ...
        <View style={styles.headerCenter}>
          <ThemedText type="h4" numberOfLines={1}>{t(`storyMeta:${story.id}.title`)}</ThemedText>
      ...
      {Platform.OS === "web" && hasThaiVoice === false ? (
        <View style={[styles.warningBanner, { backgroundColor: "#FF9800" + "20" }]}>
          ...
          <ThemedText type="small" style={{ color: "#FF9800", marginLeft: Spacing.sm, flex: 1 }}>
            Thai audio not available in this browser. Use the Expo Go app on your phone for audio playback.
          </ThemedText>
        </View>
      ) : null}
        ...
        <Pressable style={styles.popupOverlay} onPress={closePopup}>
          ...
          >
            ...
            <ThemedText type="body" style={styles.popupEnglish}>
              {t(`storyVocab:${selectedWordData.word.thai}`)}
            </ThemedText>
            <View style={styles.popupButtons}>
              ...
              >
                ...
                >
                  {savedWords.has(`story-word-${story.id}-${selectedWordData.index}`) ? t("stories:saved") : t("stories:save")}
                </ThemedText>
              </Pressable>
            </View>
          </Animated.View>
