...
const MOVES: Record<string, Move> = {
  ...
  cross: {
    name: "Cross",
    thai: "หมัดตรง",
    romanization: "Mat Trong",
    number: "2",
  },
  leftHook: {
    name: "Left Hook",
    thai: "หมัดเหวี่ยงซ้าย",
    romanization: "Mat Wiang Sai",
    number: "3",
  },
  rightHook: {
    name: "Right Hook",
    thai: "หมัดเหวี่ยงขวา",
    romanization: "Mat Wiang Kwaa",
    number: "4",
  },
  leftUppercut: {
    name: "Left Uppercut",
    thai: "หมัดเสยซ้าย",
    romanization: "Mat Soei Sai",
    number: "5",
  },
  rightUppercut: {
    name: "Right Uppercut",
    thai: "หมัดเสยขวา",
    romanization: "Mat Soei Kwaa",
    number: "6",
  },
...
function ExerciseAnimation({ exerciseName, color }: ExerciseAnimationProps) {
  ...
  const render3DFigure = (
    pose: "standing" | "jumping" | "punching" | "kicking" | "kneeUp",
  ) => (
  ...
  switch (exerciseName) {
    ...
    case "Arm Circles":
      return (
        <Animated.View style={rotationStyle}>{render3DCircle()}</Animated.View>
      );
    case "Hip Rotations":
      return (
        <Animated.View style={swingStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            />
            <Path
              d="M52 80 Q45 100 40 120"
              stroke="url(#hipBodyGrad)"
              strokeWidth="11"
              strokeLinecap="round"
              fill="none"
            />
            <Path
              d="M78 80 Q85 100 90 120"
              stroke="url(#hipBodyGrad)"
              strokeWidth="11"
              strokeLinecap="round"
              fill="none"
        ...
        <Animated.View style={swingStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            <Ellipse
              ...
              rx="14"
              ry="20"
              fill="url(#sideStretchGrad)"
            />
            <Path
              d="M52 40 Q30 25 20 15"
              stroke="url(#sideStretchGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
            />
            <Path
              d="M78 40 Q95 25 110 15"
              stroke="url(#sideStretchGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
      ...
      return (
        <Animated.View style={pulseStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            />
            <Path
              d="M65 70 Q80 75 85 55 Q90 40 100 45"
              stroke="url(#quadGrad)"
              strokeWidth="12"
              strokeLinecap="round"
              fill="none"
      ...
      return (
        <Animated.View style={pulseStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            <Path
              d="M37 55 Q25 60 20 65"
              stroke="url(#hipFlexGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
            />
            <Path
              d="M63 55 Q75 60 80 65"
              stroke="url(#hipFlexGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
      ...
      return (
        <Animated.View style={swingStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            />
            <Path
              d="M52 42 Q35 45 25 50 Q40 55 55 50"
        ...
        <Animated.View style={swingStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            <Ellipse
              ...
              rx="14"
              ry="20"
              fill="url(#neckStretchGrad)"
            />
            <Path
              d="M52 50 Q40 55 35 60"
              stroke="url(#neckStretchGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
            />
            <Path
              d="M78 50 Q90 55 95 60"
              stroke="url(#neckStretchGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
      ...
      return (
        <Animated.View style={swingStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            <Path
              d="M52 55 Q30 50 20 55"
              stroke="url(#seatedGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
            />
            <Path
              d="M78 55 Q100 50 110 55"
              stroke="url(#seatedGrad)"
              strokeWidth="10"
              strokeLinecap="round"
              fill="none"
...
function FootworkAnimation({ drillName, color }: FootworkAnimationProps) {
  ...
  switch (drillName) {
    ...
    case "Bounce Step":
      return <Animated.View style={slideStyle}>{renderFeet()}</Animated.View>;
    case "Circle Left":
    case "Circle Right":
      return (
      ...
      return (
        <Animated.View style={bounceStyle}>
          <Svg width={130} height={130} viewBox="0 0 130 130">
            ...
            <Path
              d="M65 20 L100 65 L65 110 L30 65 Z"
              stroke={darkerColor}
              strokeWidth="3"
              fill="none"
              strokeDasharray="6 4"
    ...
    default:
      return <Animated.View style={bounceStyle}>{renderFeet()}</Animated.View>;
  }
}
...
function MoveAnimation({ moveName, color }: MoveAnimationProps) {
  ...
  const strikeStyle = useAnimatedStyle(() => ({
    transform: [
      { translateX: strike.value * 25 },
      { scale: 1 + strike.value * 0.05 },
    ],
  }));
    ...
    return (
      <Animated.View style={[strikeStyle, pulseStyle]}>
        <Svg width={150} height={100} viewBox="0 0 150 100">
          ...
          <Path
            d="M5 65 Q55 55 105 45"
            stroke="url(#crossArmGrad)"
            strokeWidth="14"
            strokeLinecap="round"
            fill="none"
          />
      ...
      <Animated.View style={[strikeStyle, pulseStyle]}>
        <Svg width={150} height={100} viewBox="0 0 150 100">
          ...
          <Path
            d={
              isLeft
                ? "M25 75 Q55 75 70 55 Q85 35 110 38"
                : "M125 75 Q95 75 80 55 Q65 35 40 38"
            }
            stroke="url(#hookGrad)"
            strokeWidth="12"
            fill="none"
  ...
  if (moveName.includes("Uppercut")) {
    return (
      <Animated.View
        style={[strikeStyle, pulseStyle, { transform: [{ rotate: "-40deg" }] }]}
      >
        <Svg width={120} height={120} viewBox="0 0 120 120">
          ...
          <Path
            d="M60 105 Q58 75 60 45"
            stroke="url(#upperGrad)"
            strokeWidth="14"
            strokeLinecap="round"
            fill="none"
          />
    ...
    return (
      <Animated.View style={kickStyle}>
        <Svg width={120} height={130} viewBox="0 0 120 130">
          ...
          <Path
            d="M60 115 Q55 85 60 60"
            stroke="url(#kneeLegGrad)"
            strokeWidth="18"
            strokeLinecap="round"
            fill="none"
          />
    ...
    return (
      <Animated.View style={[strikeStyle, pulseStyle]}>
        <Svg width={130} height={110} viewBox="0 0 130 110">
          ...
          <Path
            d="M45 60 Q35 45 40 25"
            stroke="url(#blockArmGrad)"
            strokeWidth="10"
            strokeLinecap="round"
            fill="none"
          />
          <Path
            d="M85 60 Q95 45 90 25"
            stroke="url(#blockArmGrad)"
            strokeWidth="10"
            strokeLinecap="round"
            fill="none"
...
const WARMUP_EXERCISES: WarmupExercise[] = [
  ...
  },
  {
    name: "Quad Stretch",
    thai: "ยืดต้นขา",
    romanization: "Yuet Ton Khaa",
    duration: 40,
    description: "Front thigh stretch",
  },
  {
    name: "High Knees",
    thai: "ยกเข่าสูง",
    romanization: "Yok Khao Soong",
    duration: 60,
    description: "Cardio warm up",
  },
  {
    name: "Leg Swings",
    thai: "แกว่งขา",
    romanization: "Kwaeng Khaa",
    duration: 45,
  ...
  },
  {
    ...
    thai: "ยืดขาหลัง",
    romanization: "Yuet Khaa Lang",
    duration: 40,
    description: "Back of leg stretch",
  },
  {
    name: "Shadow Boxing",
    thai: "ชกลม",
    romanization: "Chok Lom",
    duration: 90,
    description: "Light punching practice",
  },
  {
    name: "Neck Rotations",
    thai: "หมุนคอ",
    romanization: "Mun Kho",
    duration: 30,
  ...
  },
  {
    name: "Calf Stretch",
    thai: "ยืดน่อง",
    romanization: "Yuet Nong",
    duration: 40,
    description: "Lower leg stretch",
  },
  {
    name: "Ankle Circles",
    thai: "หมุนข้อเท้า",
    romanization: "Mun Kho Thao",
    duration: 30,
  ...
  },
  {
    name: "Light Bouncing",
    thai: "เด้งเบาๆ",
    romanization: "Deng Bao Bao",
    duration: 60,
    description: "Ready stance practice",
  },
  {
    name: "Slow Teeps",
    thai: "ถีบช้าๆ",
    romanization: "Teep Cha Cha",
    duration: 60,
    description: "Kick technique warm up",
  },
  {
    name: "Knee Raises",
    thai: "ยกเข่า",
    romanization: "Yok Khao",
    duration: 60,
...
const FOOTWORK_DRILLS: FootworkDrill[] = [
  {
    name: "Basic Shuffle",
    thai: "สลับเท้า",
    romanization: "Sa-lap Thao",
    duration: 45,
    description: "Side to side movement",
  },
  {
    name: "Forward-Back Step",
    thai: "ก้าวหน้า-ถอย",
    romanization: "Kaao Naa - Thoi",
    duration: 45,
    description: "In and out movement",
  },
  {
    name: "Circle Left",
    thai: "วงกลมซ้าย",
    romanization: "Wong Klom Saai",
    duration: 40,
    description: "Pivot around opponent",
  },
  {
    name: "Circle Right",
    thai: "วงกลมขวา",
    romanization: "Wong Klom Khwaa",
    duration: 40,
    description: "Pivot around opponent",
  },
  {
    name: "Diamond Steps",
    thai: "สี่เหลี่ยม",
    romanization: "Sii Liam",
    duration: 50,
    description: "Move in diamond pattern",
  },
  {
    name: "Angle Off",
    thai: "หลบมุม",
    romanization: "Lop Mum",
    duration: 45,
    description: "Cut angles after strikes",
  },
  {
    name: "Switch Stance",
    thai: "สลับท่า",
    romanization: "Sa-lap Thaa",
    duration: 40,
    description: "Orthodox to southpaw",
  },
  {
    name: "Retreat & Reset",
    thai: "ถอยแล้วตั้งรับ",
    romanization: "Thoi Laeo Tang Rap",
    duration: 45,
  ...
  },
  {
    name: "Bounce Step",
    thai: "เด้งเท้า",
    romanization: "Deng Thao",
    duration: 40,
    description: "Stay light and mobile",
  },
  {
    name: "L-Step",
    thai: "ก้าวตัวแอล",
    romanization: "Kaao Tua L",
    duration: 45,
    description: "Exit at 90 degrees",
  },
  {
    name: "Pendulum",
    thai: "เหวี่ยง",
    romanization: "Wiang",
    duration: 50,
    description: "Weight shift rhythm",
  },
  {
    name: "Check Step",
    thai: "ก้าวเช็ค",
    romanization: "Kaao Check",
    duration: 40,
    description: "Feint with footwork",
  },
];
...
const COOLDOWN_EXERCISES: WarmupExercise[] = [
  {
    name: "Deep Breathing",
    thai: "หายใจลึก",
    romanization: "Hai Jai Luek",
    duration: 45,
    description: "Slow your heart rate",
  },
  {
    name: "Standing Side Stretch",
    thai: "ยืดข้าง",
  ...
  },
  {
    ...
    thai: "ยืดไหล่",
    romanization: "Yuet Lai",
    duration: 40,
    description: "Shoulder release",
  },
  {
    name: "Tricep Stretch",
    thai: "ยืดแขน",
    romanization: "Yuet Khaen",
    duration: 40,
    description: "Upper arm stretch",
  },
  {
    name: "Neck Stretch",
    thai: "ยืดคอ",
    romanization: "Yuet Kho",
    duration: 40,
    description: "Neck release",
  },
  {
    name: "Seated Twist",
    thai: "บิดตัวนั่ง",
    romanization: "Bit Tua Nang",
    duration: 50,
  ...
  },
  {
    ...
    duration: 50,
    description: "Inner thigh stretch",
  },
  {
    name: "Child's Pose",
    thai: "ท่าเด็ก",
    romanization: "Thaa Dek",
    duration: 60,
    ...
    combinations: [
      {
        ...
        description: "The fundamental punch combo",
        repetitions: 12,
      },
      {
        id: "b2",
      ...
      },
      {
        id: "b3",
        name: "Double Jab",
        moves: [MOVES.jab, MOVES.jab, MOVES.cross],
        description: "Set up with jabs",
        repetitions: 10,
      },
      {
        id: "b4",
      ...
      },
      {
        id: "b8",
        name: "Hook Practice",
        moves: [MOVES.leftHook, MOVES.rightHook],
        description: "Power hooks",
        repetitions: 12,
      },
      {
        id: "b9",
        name: "Teep-Cross",
        moves: [MOVES.teep, MOVES.cross],
        description: "Push and punch",
        repetitions: 12,
      },
      {
        id: "b10",
  ...
  },
  {
    ...
    combinations: [
      ...
      },
      {
        id: "i6",
        name: "1-2-3-2",
        moves: [MOVES.jab, MOVES.cross, MOVES.leftHook, MOVES.cross],
        description: "Boxing combo",
        repetitions: 10,
      },
      {
        id: "i7",
        name: "Teep-Knee",
        moves: [MOVES.teep, MOVES.rightKnee],
        description: "Push then knee",
        repetitions: 12,
      },
      {
        id: "i8",
        name: "Hook-Kick",
        moves: [MOVES.leftHook, MOVES.rightKick],
        description: "Same side attack",
        repetitions: 12,
      },
      {
        id: "i9",
        name: "Triple Kick",
        moves: [MOVES.rightKick, MOVES.leftKick, MOVES.rightKick],
        description: "Kick flow",
        repetitions: 10,
      },
      {
        id: "i10",
        name: "1-2-Elbow",
        moves: [MOVES.jab, MOVES.cross, MOVES.leftElbow],
  ...
  },
  {
    ...
    combinations: [
      ...
      },
      {
        ...
        description: "Clinch weapons",
        repetitions: 10,
      },
      {
        id: "a7",
        name: "Triple Kick Flow",
        moves: [MOVES.rightKick, MOVES.leftKick, MOVES.rightKick, MOVES.teep],
        description: "Kick variety",
        repetitions: 12,
      },
      {
        id: "a8",
      ...
      },
      {
        ...
        description: "Inside fighting",
        repetitions: 10,
      },
      {
        id: "a10",
        name: "Teep-Kick-Knee",
        moves: [MOVES.teep, MOVES.rightKick, MOVES.rightKnee],
        description: "Leg weapons",
        repetitions: 12,
      },
      {
        id: "a11",
...
const TRAINING_SCHEDULES: Record<string, TrainingDay[]> = {
  beginner: Array.from({ length: 30 }, (_, i) => {
    ...
    if (dayOfWeek === 7)
      return { day, type: "rest", description: "Full rest day - recover" };
    if (dayOfWeek === 4)
      return {
        day,
...
export default function MuayThaiWorkoutScreen() {
  ...
  const footworkIntervalRef = useRef<ReturnType<typeof setInterval> | null>(
    null,
  );
  ...
  const currentMove =
    currentMoveIndex >= 0 && currentCombo
      ? currentCombo.moves[currentMoveIndex]
      : null;
  ...
  const startWarmup = (workout: Workout) => {
    ...
    const text = useThai
      ? "เริ่มอบอุ่นร่างกาย"
      : "Starting warmup. Let's get your body ready.";
    speakText(text, 0.85);
  ...
  const startFootwork = (workout: Workout) => {
    ...
    const text = useThai
      ? "ฝึกก้าวเท้า เคลื่อนไหวให้คล่อง"
      : "Footwork drills. Stay light on your feet.";
    speakText(text, 0.85);
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
  ...
  const startFootworkDrill = (index: number, workout: Workout) => {
    ...
    if (index >= drillsForLevel) {
      const text = useThai
        ? "ฝึกก้าวเท้าเสร็จแล้ว เริ่มคอมโบ"
        : "Footwork complete. Starting combinations.";
      speakText(text, 0.85);
      timerRef.current = setTimeout(() => {
        if (isActiveRef.current) {
  ...
  const startMainWorkout = (workout: Workout) => {
    ...
    setCountdown(5);
    const text = useThai
      ? "เตรียมตัว ห้า สี่ สาม สอง หนึ่ง"
      : "Get ready. 5, 4, 3, 2, 1";
    speakText(text);
  ...
  const skipCooldown = () => {
    ...
    setPhase("complete");
    speakText(
      useThai ? "ฝึกซ้อมเสร็จแล้ว ทำได้ดีมาก" : "Workout complete. Great job!",
    );
    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
  };
  ...
  const startCooldown = () => {
    ...
    setCurrentCooldownIndex(0);
    const text = useThai
      ? "เริ่มคูลดาวน์ ยืดกล้ามเนื้อ"
      : "Starting cooldown. Let's stretch and recover.";
    speakText(text, 0.85);
    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
          ...
          <View style={styles.centerContent}>
            {phase === "warmup" ? (
              <>
                ...
                >
                  {useThai
                    ? "ยืดกล้ามเนื้อและเตรียมร่างกาย"
                    : "Stretching and preparing your body"}
                </ThemedText>
              </>
            ) : (
              <>
                <View style={styles.warmupProgress}>
                  ...
                  >
                    Exercise {currentWarmupIndex + 1} /{" "}
                    {WARMUP_EXERCISES.length}
                  </ThemedText>
                  <View
                    style={[
                      styles.progressBar,
                ...
                <View style={styles.skipButtonsRow}>
                  <Pressable
                    ...
                    style={[styles.skipButton, { borderColor: "#FF9800" }]}
                  >
                    <Feather name="skip-forward" size={16} color="#FF9800" />
                    <ThemedText
                      type="small"
                      style={{ color: "#FF9800", marginLeft: Spacing.xs }}
                    >
          ...
          <View style={styles.centerContent}>
            {phase === "footwork" ? (
              ...
              <>
                ...
                >
                  {useThai
                    ? currentFootwork.romanization
                    : currentFootwork.description}
                </ThemedText>

                <View style={styles.skipButtonsRow}>
                  <Pressable
                    onPress={skipFootworkDrill}
                    style={[styles.skipButton, { borderColor: "#2196F3" }]}
                  >
                    <Feather name="skip-forward" size={16} color="#2196F3" />
                    <ThemedText
                      type="small"
                      style={{ color: "#2196F3", marginLeft: Spacing.xs }}
                    >
                      {useThai ? "ข้ามท่านี้" : "Skip Drill"}
                    </ThemedText>
                  </Pressable>
                  <Pressable
                    onPress={skipFootwork}
                    style={[
                      styles.skipButton,
                      { borderColor: theme.textSecondary },
                    ]}
              ...
              <>
                <View style={styles.warmupProgress}>
                  <ThemedText
                    ...
                    style={{ color: theme.textSecondary }}
                  >
                    Stretch {currentCooldownIndex + 1} /{" "}
                    {COOLDOWN_EXERCISES.length}
                  </ThemedText>
                  <View
                    style={[
                      styles.progressBar,
                ...
                >
                  {useThai
                    ? currentCooldown.romanization
                    : currentCooldown.description}
                </ThemedText>

                <View style={styles.skipButtonsRow}>
                  <Pressable
                    onPress={skipCooldownExercise}
                    style={[styles.skipButton, { borderColor: "#9C27B0" }]}
                  >
                    <Feather name="skip-forward" size={16} color="#9C27B0" />
                    <ThemedText
                      type="small"
                      style={{ color: "#9C27B0", marginLeft: Spacing.xs }}
                    >
          ...
          <>
            <View style={styles.progressSection}>
              ...
              <ThemedText type="small" style={{ color: theme.textSecondary }}>
                Combo {currentComboIndex + 1} /{" "}
                {selectedWorkout.combinations.length}
                {currentCombo?.repetitions
                  ? ` (Rep ${currentRepetition + 1}/${currentCombo.repetitions})`
                  : ""}
              </ThemedText>
            </View>
            ...
            {phase === "countdown" ? (
              ...
              <View style={styles.centerContent}>
                <ThemedText
                  type="h1"
                  style={[styles.countdownText, { color: "#FF9800" }]}
                >
                  {restCountdown}
                </ThemedText>
                <ThemedText type="body" style={{ color: theme.textSecondary }}>
                  {useThai
                    ? "พัก - คอมโบถัดไปกำลังมา"
              ...
              <View style={styles.centerContent}>
                {currentCombo ? (
                  <>
                    ...
                    <Animated.View
                      style={[styles.moveDisplay, animatedMoveStyle]}
                    >
                      {currentMove ? (
                        <>
                    ...
                    <View style={styles.comboPreview}>
                      {currentCombo.moves.map((move, idx) => (
                        ...
                        >
                          ...
                          >
                            {useThai
                              ? move.romanization.split(" ")[0]
                              : move.number || move.name.split(" ")[0]}
                          </ThemedText>
                        </View>
                      ))}
                    </View>
                    ...
                    <View style={styles.skipButtonsRow}>
                      <Pressable
                        ...
                        style={[
                          styles.skipButton,
                          { borderColor: LEVEL_COLORS[selectedWorkout.level] },
                        ]}
                      >
                        <Feather
                          name="skip-forward"
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.languageToggle}>
          <ThemedText type="body">Voice Commands:</ThemedText>
          <View style={styles.toggleContainer}>
            <ThemedText
              type="body"
              style={{ color: !useThai ? theme.primary : theme.textSecondary }}
            >
              English
            </ThemedText>
            <Switch
            ...
            <ThemedText
              type="body"
              style={{ color: useThai ? "#FF9800" : theme.textSecondary }}
            >
              Thai
            </ThemedText>
          </View>
          ...
          <Card key={workout.id} style={{ marginTop: Spacing.lg }}>
            <View style={styles.workoutCard}>
                ...
                <View style={styles.workoutTitleRow}>
                  ...
                  >
                    <ThemedText
                      type="small"
                      style={{
                        color: LEVEL_COLORS[workout.level],
                        fontWeight: "600",
                      }}
                    >
              ...
              <Pressable
                ...
                style={[
                  styles.startButton,
                  { backgroundColor: LEVEL_COLORS[workout.level] },
                ]}
              >
